...
#include <vector>
// 十五位身份证号表达式
#define ID_NUMBER_15_REGEX "^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}$"
// 十八位身份证号表达式 identity_util
#define ID_NUMBER_18_REGEX "^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$"
using namespace std;
static map<int, string> AREA_INFO = {
    {110000,"北京市"},
    {110100,"北京市市辖区"},
    {110101,"北京市东城区"},
    {110102,"北京市西城区"},
